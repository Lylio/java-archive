...
/**
 * P9.17 Declare an interface Filter as follows:
...
Then write a program that reads all words from System.in, puts them into an ArrayList<
Object>, calls collectAll,
and prints a list of the short words.
 * @author Lyle
 *
 */
public class P9_17 {
