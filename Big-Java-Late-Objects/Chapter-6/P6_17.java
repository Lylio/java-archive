 ...
 * well.) Randomly divide them into some number of piles of random size. For example,
 ...
 * applying the solitaire
 * step and print the result. Stop when the solitaire final configuration
 * is reached.
 * @author Lyle
 *
 */
